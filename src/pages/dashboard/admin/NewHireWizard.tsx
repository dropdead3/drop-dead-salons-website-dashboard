...
export default function NewHireWizard() {
  ...
  // Pre-fill from applicant if coming from recruiting pipeline
    ...
    <DashboardLayout>
      <div className="p-6 lg:p-8 max-w-3xl mx-auto space-y-6">
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            <h1 className="font-display text-3xl lg:text-4xl">New Hire Wizard</h1>
            <p className="text-muted-foreground mt-1">Onboard a new team member step by step</p>
          </div>
        </div>
          ...
          {hireResult && (
            <div className="space-y-4">
              ...
              <div className="flex gap-2 pt-2">
                <Button onClick={() => navigate('/dashboard/admin/management')} className="flex-1">
