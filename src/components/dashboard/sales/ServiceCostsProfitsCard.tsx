        ...
        <CardContent>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            ...
            <div className="rounded-lg bg-muted/30 px-4 py-3">
              ...
              <p className={cn('font-display text-lg tracking-wide tabular-nums', data.totals.profit >= 0 ? 'text-success' : 'text-destructive')}>
            ...
            <div className="rounded-lg bg-muted/30 px-4 py-3">
              ...
              <p className={cn('font-display text-lg tracking-wide tabular-nums', data.totals.profitPct >= 50 ? 'text-success' : data.totals.profitPct >= 20 ? 'text-amber-600 dark:text-amber-400' : 'text-destructive')}>
