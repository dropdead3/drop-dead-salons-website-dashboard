    ...
    const linkContent = (
      ...
      >
        ...
        {!isCollapsed && badgeCount !== undefined && badgeCount > 0 && (
          <span className="inline-flex items-center justify-center h-5 min-w-5 px-1.5 text-[10px] font-medium rounded-md border bg-red-100 text-red-700 border-red-300 shadow-sm dark:bg-red-950/60 dark:text-red-300 dark:border-red-500/40 dark:shadow-[0_0_8px_rgba(220,38,38,0.15)]">
