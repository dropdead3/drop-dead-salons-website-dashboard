...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title 
    ref={ref} 
    className={cn("text-lg font-display uppercase tracking-wide", className)} 
    {...props} 
  />
));
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action 
    ref={ref} 
    className={cn(buttonVariants(), "shadow-lg transition-all duration-300 hover:shadow-xl", className)} 
    {...props} 
  />
));
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ref={ref}
    className={cn(buttonVariants({ variant: "outline" }), "border-oat/50 hover:bg-oat/20 hover:border-oat transition-all duration-300", className)}
    {...props}
  />
));
