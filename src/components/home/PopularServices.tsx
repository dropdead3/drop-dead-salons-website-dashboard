...
export function PopularServices() {
  ...
  return (
    <Section className="py-16 md:py-20 pb-20 md:pb-28" theme="light">
      <motion.div
        ref={ref}
        ...
        <div className="flex flex-wrap justify-center gap-3 md:gap-4 max-w-6xl mx-auto">
          {popularServices.map((service, index) => (
            ...
            >
              <Link
                to="/services"
                className="group/btn inline-flex items-center px-6 py-4 text-base font-sans text-foreground bg-card border border-border rounded-full transition-all duration-300 ease-out hover:bg-foreground hover:text-background hover:border-foreground hover:scale-105 hover:shadow-lg"
              >
                {service}
