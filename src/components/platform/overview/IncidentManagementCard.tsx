...
export function IncidentManagementCard() {
  ...
  // Fetch active + recent resolved incidents
    ...
    <div className="rounded-2xl border border-slate-700/50 bg-slate-800/40 backdrop-blur-xl p-6">
      <div className="flex items-center justify-between mb-5">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-semibold text-white">Active Incident</h2>
        </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-3 mt-2 text-xs text-slate-500">
                  ...
                  {activeIncident.is_auto_created && (
                    <span className="px-1.5 py-0.5 rounded bg-slate-700 text-slate-400 text-[10px]">AUTO</span>
                  )}
                </div>
              </div>
            </div>
        ...
        <div className="rounded-xl border border-slate-600/50 bg-slate-700/30 p-4 mb-4 space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full bg-slate-800/60 border border-slate-600/50 rounded-lg px-3 py-2 text-sm text-white placeholder:text-slate-500 focus:outline-none focus:border-violet-500/50"
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              rows={2}
              className="w-full bg-slate-800/60 border border-slate-600/50 rounded-lg px-3 py-2 text-sm text-white placeholder:text-slate-500 focus:outline-none focus:border-violet-500/50 resize-none"
            />
          </div>
      ...
      {pastIncidents.length > 0 && (
        <div className="mt-4 pt-4 border-t border-slate-700/50">
          <p className="text-xs font-medium text-slate-500 mb-2">Recent Resolved</p>
          <div className="space-y-2">
            {pastIncidents.map(inc => (
              <div key={inc.id} className="flex items-center justify-between text-xs text-slate-500">
