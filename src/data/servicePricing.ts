...
export const services: ServiceCategory[] = [
  ...
  },
  {
    ...
    items: [
      { name: "Maintenance Cut", description: "Quick trim to maintain your current shape", prices: { 'new-talent': '$15', 'emerging': '$17', 'lead': '$20', 'senior': '$23', 'signature': '$26', 'icon': '$30' } },
      { name: "Add-On Cut", description: "Haircut added to any color service", prices: { 'new-talent': '$45', 'emerging': '$52', 'lead': '$60', 'senior': '$68', 'signature': '$79', 'icon': '$91' } },
      { name: "Signature Cut", description: "Our signature precision haircut with consultation", prices: { 'new-talent': '$65', 'emerging': '$75', 'lead': '$86', 'senior': '$99', 'signature': '$114', 'icon': '$131' } },
      { name: "Specialty Cut", description: "Advanced cutting techniques for unique styles", prices: { 'new-talent': '$75', 'emerging': '$86', 'lead': '$99', 'senior': '$114', 'signature': '$131', 'icon': '$151' } },
      { name: "Transformation Cut", description: "Complete style overhaul for a new look", prices: { 'new-talent': '$75', 'emerging': '$86', 'lead': '$99', 'senior': '$114', 'signature': '$131', 'icon': '$151' } },
      { name: "Buzz Cut", description: "Clean, close-cropped clipper cut", prices: { 'new-talent': '$35', 'emerging': '$40', 'lead': '$46', 'senior': '$53', 'signature': '$61', 'icon': '$70' } },
      { name: "Clipper Cut", description: "Classic clipper work with blending", prices: { 'new-talent': '$40', 'emerging': '$46', 'lead': '$53', 'senior': '$61', 'signature': '$70', 'icon': '$80' } },
      { name: "Fade", description: "Expertly blended fade with precision detailing", prices: { 'new-talent': '$50', 'emerging': '$58', 'lead': '$66', 'senior': '$76', 'signature': '$87', 'icon': '$101' } },
      { name: "Combo Cut", description: "Clipper and shear work for versatile styles", prices: { 'new-talent': '$60', 'emerging': '$69', 'lead': '$79', 'senior': '$91', 'signature': '$105', 'icon': '$121' } },
