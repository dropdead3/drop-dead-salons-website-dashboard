...
export const services: ServiceCategory[] = [
  ...
  },
  {
    ...
    items: [
      { name: "Maintenance Cut", description: "Quick trim to maintain your current shape (wash & blowout not included)", prices: { 'new-talent': '$15', 'emerging': '$17', 'lead': '$20', 'senior': '$23', 'signature': '$26', 'icon': '$30' } },
